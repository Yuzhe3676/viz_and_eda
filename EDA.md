...
group_by you can also use command `ungroup(name, month)` to ungroup the
layer you just construct
...
```
    ...
    ## # A tibble: 2,190 × 8
    ## # Groups:   name [3]
    ##    name          id    date        prcp  tmax  tmin month      threedaysago_tmax
    ##    <chr>         <chr> <date>     <dbl> <dbl> <dbl> <date>                 <dbl>
    ##  1 CentralPark_… USW0… 2021-01-01   157   4.4   0.6 2021-01-01              NA  
    ##  2 CentralPark_… USW0… 2021-01-02    13  10.6   2.2 2021-01-01              NA  
    ##  3 CentralPark_… USW0… 2021-01-03    56   3.3   1.1 2021-01-01              NA  
    ##  4 CentralPark_… USW0… 2021-01-04     5   6.1   1.7 2021-01-01               4.4
    ##  5 CentralPark_… USW0… 2021-01-05     0   5.6   2.2 2021-01-01              10.6
    ##  6 CentralPark_… USW0… 2021-01-06     0   5     1.1 2021-01-01               3.3
    ##  7 CentralPark_… USW0… 2021-01-07     0   5    -1   2021-01-01               6.1
    ##  8 CentralPark_… USW0… 2021-01-08     0   2.8  -2.7 2021-01-01               5.6
    ##  9 CentralPark_… USW0… 2021-01-09     0   2.8  -4.3 2021-01-01               5  
    ## 10 CentralPark_… USW0… 2021-01-10     0   5    -1.6 2021-01-01               5  
    ## # ℹ 2,180 more rows
